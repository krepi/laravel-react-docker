    ...
    return (
        <>
            ...
            <div
                ...
                <div className="max-w-7xl min-w-5xl mx-auto p-6 lg:p-8 bg-white">


                    <section className='header'>
                        <div className="banner">
                            <h1 className="hero">DishDock</h1>
                            <p className="hero_description">tutaj znajdziesz wszystko co potrzebne</p>
                            <button className="login_button">Zaloguj się</button>
                        </div>
                    </section>
                    <section>
