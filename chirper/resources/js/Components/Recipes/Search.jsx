...
export default function Search() {
    ...
    return (
        ...
        <form onSubmit={handleSearch} className="max-w-7xl mx-auto p-4 bg-white shadow rounded-lg sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-4">
                <button type="submit" className="px-4 py-2 rounded bg-green-500 text-white hover:bg-green-700 focus:outline-none focus:shadow-outline">
                    Search
                </button>
            </div>
        </form>
